...
To look at how accents are portrayed in the media, I have conducted a quantitative content analysis which focuses on the Glaswegian vernacular (GV) accent. Like many other working-class, urban language varieties, the GV accent is heavily stigmatised and is often downgraded in terms of status. 
...
A total of 5825 data points was coded by a team of coders, looking at 233 characters across 12 films. These characters were rated across dimensions of social attributes, behaviours and their accent variety. 
...
<img src="img/content.png" style="height: 100%; width: 100%; object-fit: contain" onclick="window.open('', 'blank');"/>

Watch this space...

I will be presenting the results of this research at [BAAP2024, March 2024](https://sites.google.com/view/baap-2024/en){target='_blank'}. 
